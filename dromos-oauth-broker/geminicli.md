...
- **Fix Applied**: Consolidated routes using `chi.Route("/providers", ...)` pattern in `cmd/oauth-broker/main.go`
...
- **Azure OAuth Broker URL**: `https://dromos-oauth-broker.bravesea-3f5f7e75.eastus.azurecontainerapps.io`
- **Azure Gateway URL**: `https://dromos-oauth-gateway.bravesea-3f5f7e75.eastus.azurecontainerapps.io`
